  ...
  <link href="{{ asset('css/bootstrap.min.css') }}" rel="stylesheet">
        ...
        <style>
            ...
            @media (min-width:1024px){.lg\:px-8{padding-left:2rem;padding-right:2rem}}
             .dark\:bg-gray-900{--bg-opacity:1;background-color:#ffffff;}        </style>
...
<a href="{{ route('checar.carrito') }}" ><h3> En carrito: <span class="badge badge-danger"> {{ count(Cart::getContent()) }}</span> </h3></a>
<?php
...
//echo "$sessiontostring";
     ...
     ?>
                      ...
                      <div class="row p-5  border  col8 ">
                        @foreach($productos as $item)
                        <div class="row p-6 grid:md-2">

                            <img src=" /img/{{$item->urlfoto  }}" width="50" style="width: 229px; height: 229px; margin: 0px;" class="p-3">
                                                      <div class="col-sm p-5 border  alert alert-dark" >

                                                        <h4 class="alert-heading">{{ $item->nombre }}</h4>
                                                        <p class="mb-4">${{ $item->precio }} cuc</p>

                                                        <form action="{{ route('agrega.carrito') }}" method="post">
                                                        @csrf

                                                        <span for="quantity" class="badge badge-warning badge-pill ">En stock: <span class="badge badge-danger"> {{ $item->cantidad }}</span></span>
                                                        <p>Cantidad a comprar:
                                                        <input type="number" id="quantity" name="cantidad" min="0" max="{{ $item->cantidad }}" style="width: 40px" placeholder="0" >
