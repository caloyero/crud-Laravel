    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen   sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="row p-5">
<a href="{{ route('checar.carrito') }}" > En carrito: <span class="badge badge-danger"> {{ count(Cart::getContent()) }}</span> </a>

<div class="col-sm-10  p-5">
<div class="float-sm-right clearfix">
...
$elimina = array("\"", "[", "]");
      ...
      ?>
<td><img src=" /img/{{ $urlfoto }}" width="50" style="width: 229px; height: 229px; margin: 0px;"></td>
      <td>{{ $row->id }}</td>
      <td>
      {{ $row->name}}
      </td>
      ...
      <td>{{ $row->price}}</td>
       ...
       @csrf
       <td><input type="hidden" name="producto_id" value="{{ $row->id }}">
...
<tr>
<td>
 <form action="{{ route('limpia.carrito') }}" method="post">
       @csrf
       <td>
         <input class="btn btn-warning" type="submit" name="Limpiar" value="Limpiar Carrito">
                                    </form>
</td>
</tr>
  </tbody>
